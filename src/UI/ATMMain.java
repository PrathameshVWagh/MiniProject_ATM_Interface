...
import serviceImpl.BankImplementation;

public class ATMMain {

	public static void main(String[] args) throws NumberFormatException, IOException,InputMismatchException,NullPointerException{
